                ...
                for trait in sqlchar.traits_list:
                    if trait.category.name.upper() == category.name.upper():
                        ...
                        new_trait = CharacterTrait(
                            category_name=trait.category.name.upper(),
